...
### 📝 Detailed Comments
- ℹ️ **scripts/gpt-code-review.ts** (line 45): Consider adding a timeout for API calls
- ⚠️ **scripts/gpt-code-review.ts** (line 120): Truncation logic could be improved with smart splitting

---
*This review was generated by GPT-4o-mini and should be used as a supplementary tool to human code review.*
```
...
📝 Context: Check for completeness and clarity
...
🎯 Target: HEAD~20..HEAD
📝 Context: Focus on code quality trends
...
**Error in logs:**
```
❌ Error during GPT review: Error: OpenAI API call failed: 429 Rate limit exceeded
```
...
**Output:**
```
ℹ️  No code changes detected. Skipping review.
```

...
- When you must call an LLM or helper script, stick to the GitHub Copilot CLI context (defaulting to a cost-efficient model) and keep any secrets redacted in all outputs.
